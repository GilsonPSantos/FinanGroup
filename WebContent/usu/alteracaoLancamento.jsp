...
<body>
   ...
   <div class="modal-dialog">
    ...
    <h4 class="modal-title">Alterar Lancamento</h4>
   </div>
   <div class="modal-body">
     
     <s:form method="post" action="lancamento.alterar"
           cssClass="form-group" theme="simple" id="form1" role="form">
           
           
      <s:hidden name="lancamento.idLancamento"></s:hidden> 
      
       <label for="nome">Nome do Lancamento</label>
      <s:textfield label="nome" name="lancamento.nomeLancamento" id="nome" cssClass="form-control"></s:textfield>

        <br/><br/>      
     
      	<s:date name="lancamento.dataLancamento" var="date" format="dd/MM/yyyy"/>
		<s:textfield value="%{date}" name="lancamento.dataLancamento" type="text" required="required" id="data3" cssClass="form-control" placeholder="dd/mm/yyyy"/>		
     ...
     <label for="celular">Valor</label>
      <input label="email" name="valorLancamento" value="${lancamento.valorLancamento}" id="email" cssClass="form-control"/>
