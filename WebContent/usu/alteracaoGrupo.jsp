...
<body>
   ...
   <div class="modal-body">
     ...
     <s:form method="post" action="grupo.alterar"
           cssClass="form-group" theme="simple" id="form1" role="form">
           
           
      <s:hidden name="grupo.idGrupo"></s:hidden> 
      
       <label for="nome">Nome</label>
      <s:textfield label="nome" name="grupo.nome" id="nome" cssClass="form-control"></s:textfield>
